 ...
 * <ul>
 *   <li>{@link org.project.droolsDSL.ddsl.impl.AtTimeCurrentTimeImpl#getAtTimeValue <em>At Time Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AtTimeCurrentTimeImpl extends AtExprImpl implements AtTimeCurrentTime
{
  ...
  {
    return DdslPackage.Literals.AT_TIME_CURRENT_TIME;
  }
  ...
  public void setAtTimeValue(String newAtTimeValue)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DdslPackage.AT_TIME_CURRENT_TIME__AT_TIME_VALUE, oldAtTimeValue, atTimeValue));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case DdslPackage.AT_TIME_CURRENT_TIME__AT_TIME_VALUE:
