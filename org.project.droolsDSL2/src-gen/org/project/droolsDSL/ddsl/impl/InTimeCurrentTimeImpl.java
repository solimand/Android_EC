 ...
 * <ul>
 *   <li>{@link org.project.droolsDSL.ddsl.impl.InTimeCurrentTimeImpl#getInTimeValue <em>In Time Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class InTimeCurrentTimeImpl extends InExprImpl implements InTimeCurrentTime
{
  ...
  {
    return DdslPackage.Literals.IN_TIME_CURRENT_TIME;
  }
  ...
  public void setInTimeValue(String newInTimeValue)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DdslPackage.IN_TIME_CURRENT_TIME__IN_TIME_VALUE, oldInTimeValue, inTimeValue));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case DdslPackage.IN_TIME_CURRENT_TIME__IN_TIME_VALUE:
